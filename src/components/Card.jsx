...
import {formatToCurrency, updateApi, getLocalStorage, setLocalStorage} from '../GeralFunctions'
...
export default function Card({product, setProds}){
  ...
  const OutStockButton =(<SoldOutBtn format='soldOut' onClick={() => navigate('/account')} > Notify me when available</SoldOutBtn>)
    ...
    <> 
      <CardStyle>
        ...
        <div className="card-text">
          ...
          <p className="light-text"> {product.category} </p>
